...
.PHONY: all clean tools tests test-cpu test-cpu-core test-cpu65c816 test-cpu65c816-e test-cpu65c816-n test-klaus test-boot-dual test-paravirt test-oricos-boot test-oricos-visual test-oricos-sd test-oricos-hires2 test-memory test-oric2-memory test-compositor test-compositor-hires-oric2 test-io test-storage test-system test-rom test-video test-hires-oric2 test-audio test-debugger test-cast test-savestate test-atmos test-joystick test-printer test-mcp40 test-renderer test-trace test-profiler test-rominfo test-serial test-keyboard valgrind static-analysis coverage coverage-report install uninstall help
...
tests: test-cpu test-cpu-core test-cpu65c816 test-cpu65c816-e test-cpu65c816-n test-klaus test-boot-dual test-paravirt test-oricos-boot test-oricos-visual test-oricos-sd test-oricos-hires2 test-memory test-oric2-memory test-compositor test-compositor-hires-oric2 test-io test-storage test-system test-video test-hires-oric2 test-audio test-debugger test-savestate test-atmos test-joystick test-printer test-mcp40 test-renderer test-trace test-profiler test-rominfo test-serial test-keyboard test-coverage
	@echo ""
	@echo "═══════════════════════════════════════════════════════"
