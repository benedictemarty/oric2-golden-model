...
.PHONY: all clean tools tests test-cpu test-memory test-io test-storage test-system help
...
tests: test-cpu test-memory test-io test-storage test-system
	@echo ""
	@echo "═══════════════════════════════════════════════════════"
...
clean:
	...
	rm -f test_cpu test_memory test_io test_storage test_system
	rm -f tools/*.o
